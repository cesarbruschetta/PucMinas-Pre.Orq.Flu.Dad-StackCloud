...
@dag(
    ...
    description="Processamento dos indicadores em Spark no EMR",
    catchup=False,
    tags=["Spark", "EMR"],
)
def processer_build_metrics():
    ...
    @task
    def emr_process_metrics(success_before: bool):
        if success_before:
            newstep = client.add_job_flow_steps(
                JobFlowId=ClusterId,
                Steps=[
                    {
                        "Name": "Processamento dos indicadores",
                        ...
                        "HadoopJarStep": {
                            ...
                            "Args": [
                                ...
                                "--deploy-mode",
                                "cluster",
                                "s3://dev-datalake-artifact-643626749185/pyspark/job_spark_metrics.py",
                            ],
                        },
                    }
                ],
    ...
    # Orquestração
    start = inicio()
    indicadores = emr_process_metrics(start)
